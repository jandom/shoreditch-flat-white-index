...
```json
  "homepage": "https://myusername.github.io/shoreditch-flat-white-map",
```
...
To publish it at [https://myusername.github.io/shoreditch-flat-white-map](https://myusername.github.io/shoreditch-flat-white-map), run:
